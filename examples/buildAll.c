...
int main(void)
{
    ...
    SHU_ModuleCompile("1_single_source/", 0);
    ...
    SHU_ModuleCompile("2_compiler_flags/", 0);
#if SHUM_PLATFORM == SHUM_PLATFORM_WINDOWS
    ...
    SHU_ModuleCompile("3_main_arguments/", 0);
#if SHUM_PLATFORM == SHUM_PLATFORM_WINDOWS
    ...
    SHU_ModuleCompile("4_folder_structures/", 0);
#if SHUM_PLATFORM == SHUM_PLATFORM_WINDOWS
    ...
    SHU_ModuleCompile("5_library_linking/", 0);
#if SHUM_PLATFORM == SHUM_PLATFORM_WINDOWS
